...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <form method="post" action="<?php echo base_url('kategori/aksi_tambah'); ?>" enctype=multipart/form-data>

          <div class="form-group">
            <label class="control-label">Kategori</label>
            <input class="form-control" type="text" required placeholder="Masukan Kategori" name="data[kategori]">
          </div>
